...
echo [1/2] Dang khoi dong FastAPI Backend tai http://localhost:8000 ...
start "Kokoro TTS - Backend" cmd /k "cd /d %~dp0backend && .venv\Scripts\activate && uvicorn main:app --host localhost --port 8000 --reload"
